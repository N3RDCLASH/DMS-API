...
ALTER TABLE
    `user_has_roles`
ADD
    CONSTRAINT `user_has_roles_role_id_foreign` FOREIGN KEY(`role_id`) REFERENCES `roles`(`id`);

ALTER TABLE
    `user_has_roles`
ADD
    CONSTRAINT `user_has_roles_user_id_foreign` FOREIGN KEY(`user_id`) REFERENCES `users`(`id`);

ALTER TABLE
    `documents`
ADD
    CONSTRAINT `documents_owner_id_foreign` FOREIGN KEY(`owner_id`) REFERENCES `users`(`id`);

ALTER TABLE
    `document_shared_with_user`
ADD
    CONSTRAINT `document_shared_with_user_document_id_foreign` FOREIGN KEY(`document_id`) REFERENCES `documents`(`id`);

ALTER TABLE
    `document_shared_with_user`
ADD
    CONSTRAINT `document_shared_with_user_user_id_foreign` FOREIGN KEY(`user_id`) REFERENCES `users`(`id`);
